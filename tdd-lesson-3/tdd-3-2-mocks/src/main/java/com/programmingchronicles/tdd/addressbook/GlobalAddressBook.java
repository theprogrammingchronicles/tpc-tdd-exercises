 ...
 *
 * <p>
 * En base a <b>SRP</b> (<i>Single Responsability Principle</i>) se extraerá la
 * responsabilidad de generación de ids usando el principio <b>DIP</b> (<i>Dependency
 * Inversion Principle</i>) o IoC.
 * </p>
 *
 * <p>
 * El IoC se aplica como principio diseño, pero como efecto lateral permite
 * obtener código fácilmente testeable con mocks/stubs. Permite la inyección
 * de mocks desde los tests sin necesidad de modificar el Object Under Test.
 * </p>
 *
 * <p>
 * En esta refactorización los tests volverán a fallar ya que se ha
 * extraido una funcionalidad y aun no se ha implementado.
 * </p>
 *
