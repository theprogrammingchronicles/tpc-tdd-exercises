 ...
 *
 * DbAddressBook no necesitará un servicio de generación de IDs, por tanto
 * no permite configurarlo por ID, y tampoco es parte de la API GlobalAddressBook,
 * ya que serían detalles de implementación.
 *
