...
public interface AddressBookDao {
     ...
     * @throws SQLDaoException Error irrecuperable de la base de datos
     */
     ...
     *
     * @param id Se ignora el id si es inválido o no existe.
     * @throws SQLDaoException Error irrecuperable de la base de datos
     */
     ...
     *
     * @return Devuelve una lista vacía si no existen contactos.
     * @throws SQLDaoException Error irrecuperable de la base de datos
     */
    List<Contact> getAll();
     ...
     * @return Devuelve null si el contacto no existe o el id es inválido.
     * @throws SQLDaoException Error irrecuperable de la base de datos
     */
